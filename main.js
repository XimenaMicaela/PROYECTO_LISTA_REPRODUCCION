...
const allProducts = [
  new Product({name: "Break On Through", price: 150,discountedPrice: 120,image: "./IMG/THEDOORS.png"}),
  new Product({name: "B.Y.O.B", price: 150,discountedPrice: 120,artista: "System of a Down", duracion: "00:04:16", anio: "2005", genero: "Trash Metal",image : "./IMG/SYSTEMOFADOWN.png"}),
  new Product({name: "Cementery Gates", artista: "Pantera", duracion: "00:07:02", anio: "2003", genero: "Metal",image :"./IMG/PANTERA.png"}),
  new Product({name: "Reptilia", artista: "The Strokes", duracion: "00:03:29", anio: "2003", genero: "Alternative",image :"./IMG/THESTROKES.png"}),
  new Product({name: "St.Anger", artista: "Metallica", duracion: "00:07:21", anio: "2003", genero: "Nu Metal",image :"./IMG/METALLICA.png"}),
  new Product({name: "Cessio", artista: "Sal y Mileto", duracion: "00:09:30", anio: "2001", genero: "Rock Experimental", image :"./IMG/SALYMILETO.png" }),
  new Product({name: "Duality", artista: "Slipknot", duracion: "00:04:12", anio: "2004", genero: "Metal",image :"./IMG/SLIPKNOT.png"}),
  new Product({name: "Santa Monica", artista: "Theory of a Deadman", duracion: "00:04:06", anio: "2005", genero: "Rock",image :"./IMG/THEORYOFADEADMAN.png" }),
  new Product({name: "Hoy tengo ganas de ti", artista: "Alejandro Fernandez", duracion: "00:04:51", anio: "2013", genero: "Balada Pop",image :"./IMG/BALADA.jpg" }),
  new Product({name: "Love Don't let Me Go", artista: "David Guetta", duracion: "00:03:36", anio: "2002", genero: "Electronica",image :"./IMG/DAVID_GUETTA_1.jpg"}),
  new Product({name: "Sexy Bitch", artista: "David Guetta", duracion: "00:03:15", anio: "2009", genero: "Electro Pop",image :"./IMG/DAVID_GUETTA_2.jpg"}),
  new Product({name: "This Ones for you (feat. Zara larsson)", artista: "David Guetta", duracion: "00:03:27", anio: "2016", genero: "EDM",image :"./IMG/DAVID_GUETTA_3.jpg"}),
  new Product({name: "When Love Takes Over", artista: "David Guetta", duracion: "00:03:11",anio: "2009", genero: "Electronica",image :"./IMG/DAVID_GUETTA_4.jpg"}),
  new Product({name: "Electrónica", artista: "...", duracion: "", anio: "", genero: "",image :"./IMG/ELECTRONICA.jpg"}),
  new Product({name: "Film Out", artista: "BTS", duracion: "3:34", anio: "2021", genero: "K-POP",image :"./IMG/FILM_OUT.jpg"}),
  new Product({name: "GUETTE", artista: "...", duracion: "...", anio: "...", genero: "..",image :"./IMG/BALADA.jpg"}),
  new Product({name: "GIVEN-TAKEN", artista: "ENHYPEN", duracion: "3:03", anio: "2020", genero: "K-POP",image :"./IMG/BorderDayOne.png"}),
  new Product({name: "Mi ex tenía Razón", artista: "Karol G", duracion: "00:02:41", anio: "2023", genero: "Pop",image :"./IMG/KAROLG.jpg" }),
  new Product({name: "Maps", artista: "Maroon 5", duracion: "00:03:09", anio: "2014", genero: "Pop rock",image :"./IMG/Marron5_Maps.jpg"}),
  new Product({name: "Memories", artista: "Maroon 5", duracion: "00:03:15", anio: "2019", genero: "Reggae fusión",image :"./IMG/Marron5_memories.jpg" }),
  new Product({name: "Sugar", artista: "Maroon 5", duracion: "00:05:02", anio: "2015", genero: "Pop rock",image :"./IMG/Marron5_Sugar.jpg" }),
  new Product({name: "Just Give me a Reason", artista: "Pink", duracion: "00:04:03", anio: "2012", genero: "Pop",image :"./IMG/Pink_Just.jpg"}),
  new Product({name: "I'm not the only one", artista: "Sam Smith", duracion: "00:03:24", anio: "2014", genero: "Soul",image :"./IMG/SMITH_3.jpg"}),
  new Product({name: "Too Good At Goodbyes", artista: "Sam Smith", duracion: "00:03:21", anio: "2018", genero: "Pop orquestal",image :"./IMG/SMITH_1.jpg"}),
  new Product({name: "Unholy", artista: "Sam Smith", duracion: "00:04:35", anio: "2023", genero: "Dance Pop",image :"./IMG/SMITH_2.jpg"}),
  new Product({name: "Writing's on the Wall", artista: "Sam Smith", duracion: "00:04:45", anio: "2015", genero: "Pop",image :"./IMG/SMITH.jpg"}),
  new Product({name: "There's Nothing Holdin' me Back", artista: "Shawn Mendes", duracion: "00:03:28", anio: "2016", genero: "Pop",image :"./IMG/Shaw_mendes.jpg"}),
  new Product({name: "Sheluvme", artista: "Tai Verdes", duracion: "2:30", anio: "2022", genero: "POP",image :"./IMG/HDTV.png"}),
  new Product({name: "TOPLINE (Feat, Tiger JK", artista: "SKZ", duracion: "2023", anio: "3:23", genero: "K-POP",image :"./IMG/SCLASS.jpg" }),
  new Product({name: "You Should be Sad", artista: "Halsey", duracion: "3:25", anio: "2020", genero: "POP",image :"./IMG/Halsey-Manic.png"})
